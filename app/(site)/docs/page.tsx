...
export const metadata: Metadata = {
  title: "Xenus Company Portfolio",
  description: "This is Docs page for Xenus",
  // other metadata
};
        ...
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-1/4">
              <div className="sticky top-[74px] rounded-lg border border-white p-4 shadow-xenus-4  transition-all  dark:border-strokedark dark:bg-blacksection">
            ...
            <div className="w-full px-4 lg:w-3/4">
              <div className="blog-details blog-details-docs shadow-three dark:bg-gray-dark rounded-sm bg-white px-8 py-11 sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]">
                <h1>Welcome to Xenus Technosoft</h1>
